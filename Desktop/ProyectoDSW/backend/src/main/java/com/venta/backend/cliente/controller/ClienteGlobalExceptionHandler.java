...
/**
 * Manejador global de excepciones para el módulo de Cliente.
...
public class ClienteGlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleRegistroCliente(RegistroClienteException ex) {
        Map<String, Object> body = new HashMap<>();
        body.put("timestamp", LocalDateTime.now());
    ...
    @ExceptionHandler(ClienteNoAptoException.class)
    public ResponseEntity<Map<String, Object>> handleClienteNoApto(ClienteNoAptoException ex) {
        Map<String, Object> body = new HashMap<>();
        body.put("timestamp", LocalDateTime.now());
        body.put("status", HttpStatus.BAD_REQUEST.value());
        body.put("error", "Cliente No Apto");
        body.put("message", ex.getMessage());
